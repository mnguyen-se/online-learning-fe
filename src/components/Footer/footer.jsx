    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section">
          <div className="footer-brand">
            <img src={logoImg} alt="Ryugo" className="footer-logo-img" />
            <div className="footer-brand-text">
              <h3 className="footer-title">RYUGO</h3>
              <span className="footer-title-ja">竜五</span>
            </div>
          </div>
          <p className="footer-description">
            Trung tâm Nhật ngữ Ryugo – Nền tảng học tiếng Nhật trực tuyến. Đồng hành cùng bạn chinh phục JLPT và hành trình Nhật Bản.
          </p>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          <p>&copy; 2026 Trung tâm Nhật ngữ Ryugo. All rights reserved.</p>
